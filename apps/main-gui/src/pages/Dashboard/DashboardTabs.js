            ...
            <Paper className={classes.paper} style={{ padding: 0 }}>
              ...
              >
                <Tab
                  label={
                    <div>
                      <AccountBoxIcon style={{ verticalAlign: "top" }} />{" "}
                      Profile
                    </div>
                  }
                  {...a11yProps(0, classes)}
                ...
                <Tab
                  label={
                    <div>
                      <BusinessIcon style={{ verticalAlign: "top" }} />{" "}
                      Organizations
                    </div>
                  }
                  {...a11yProps(1, classes)}
                ...
                <Tab
                  label={
                    <div>
                      <FlagIcon style={{ verticalAlign: "top" }} /> Language
                      &amp; Region
                    </div>
                  }
                  {...a11yProps(2, classes)}
                ...
                <Tab
                  label={
                    <div>
                      <NotificationsIcon style={{ verticalAlign: "top" }} />{" "}
                      Notifications
                    </div>
                  }
                  {...a11yProps(3, classes)}
