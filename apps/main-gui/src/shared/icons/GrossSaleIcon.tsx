...
const GrossSaleIconFactory: React.FC<IconProps> = ({ color = 'currentColor', size = 16 }) => {
	return <CreditCardRounded style={{ fill : color, fontSize : size }} />;
};

export const GrossSaleIcon: React.FC<IconProps> = GrossSaleIconFactory;
export default GrossSaleIcon;
