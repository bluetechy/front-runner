...
describe('icons/CustomerServiceIcon', () => {

	test('it renders without errors', () => {
		render(<CustomerServiceIcon />);
	});
	...
	test('it renders with custom props', () => {
		...
		const { container } = render(<CustomerServiceIcon color={color} size={size} />);
	...
	test('it takes a keyword colour as well as a hex one', () => {
		const { container } = render(<CustomerServiceIcon color="currentColor" />);
		const svgTag = container.querySelector<HTMLElement>('svg');
