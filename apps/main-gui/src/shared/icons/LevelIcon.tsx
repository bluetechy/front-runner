...
const LevelIconFactory: React.FC<IconProps> = ({ color = 'currentColor', size = 16 }) => {
	return <MilitaryTechRounded style={{ fill : color, fontSize : size }} />;
};

export const LevelIcon: React.FC<IconProps> = LevelIconFactory;
