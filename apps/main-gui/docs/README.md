...
[the landing page](landing-page.md), [the pricing page](pricing-page.md),
[the contact page](contact-page.md) and [the privacy page](privacy-page.md)
...
[the security page](security-page.md) for what is behind the login,
[the widget studio](widget-studio.md) for where a widget definition is pasted in
and published, [notifications](notifications.md) for the bell in the
