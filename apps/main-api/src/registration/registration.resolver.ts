...
// about what it does and does not open up. The identity provider already
// allows self-registration on its own hosted page, so this adds no way in
...
// email address and never with a session. See
