...
export function ParticlesElement({ node }: ElementProps<ParticlesNode>) {
  ...
  return (
    <canvas
      ...
      /* Decoration, and announced as nothing. See the note at the top: this is
       * the property that makes painting these pixels acceptable. */
      aria-hidden="true"
      style={{
        position: "absolute",
        inset: 0,
