...
export function typeScale(variant) {
...
export function styleOf(style) {
    ...
    if (style.shadow)
        css.boxShadow = "0 10px 30px rgba(0, 0, 0, 0.25)";
    return css;
}
...
export function layoutOf(layout, stacked) {
 ...
 * by hand.
 */
export function placementOf(node, mode) {
    const size = {};
 ...
 */
export function animationOf(animation) {
    if (!animation)
        return {};
    return {
